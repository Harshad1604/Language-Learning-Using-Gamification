const words = [
    ...
    { french: 'Maison', english: 'Maison' },
    { french: 'Livre', english: 'livre' },
    { french: 'Chien', english: 'Chien' },
    { french: 'Chat', english: 'Chat' },
    { french: 'Fleur', english: 'Fleur' },
    { french: 'Voiture', english: 'Voiture' },
    { french: 'Arbre', english: 'Arbre' },
    { french: 'Cuisine', english: 'Cuisine' },
    { french: 'Montagne', english: 'Montagne' }
  ];
