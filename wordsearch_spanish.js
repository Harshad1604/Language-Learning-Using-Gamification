const words = [
    { spanish: 'Hola', english: 'Hola' },
    { spanish: 'Casa', english: 'Casa' },
    { spanish: 'Libro', english: 'Libro' },
    { spanish: 'Perro', english: 'Perro' },
    { spanish: 'Gato', english: 'Gato' },
    { spanish: 'Flor', english: 'Flor' },
    { spanish: 'Coche', english: 'Coche' },
    { spanish: 'Arbol', english: 'Arbol' },
    { spanish: 'Cocina', english: 'Cocina' },
    { spanish: 'Montana', english: 'Montana' }
  ];
  ...
  function displayWordList() {
    ...
    wordList.textContent = selectedWord.spanish;
  }
  ...
  function displayFeedback(isCorrect) {
    ...
    feedback.textContent = isCorrect ? '¡Respuesta correcta!' : '¡Respuesta incorrecta!';
